...
class CircuitEnv(gym.Env):
    def __init__(self, max_components=5, value_buckets=5,
                 folder_path="../5_data", work_dir="./ltspice_env_0"):
    ...
    def get_reward(self, magVector, phaseVector, obs):
        ...
        similarity_value = 0.7*similarity_value_mag + 0.3*similarity_value_phase
